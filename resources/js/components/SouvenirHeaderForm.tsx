...
export default function SouvenirHeaderForm() {
    ...
    useEffect(() => {
        const fetchHeaderData = async () => {
            try {
                const response = await fetch('/api/souvenirs/header');
                if (response.ok) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                const refreshResponse = await fetch('/api/souvenirs/header');
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Enter page title (e.g., Souvenirs)"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Enter page subtitle (e.g., Manage souvenir products and inventory)"
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                placeholder="Enter page description (e.g., Browse our collection of authentic local souvenirs...)"
                                rows={4}
