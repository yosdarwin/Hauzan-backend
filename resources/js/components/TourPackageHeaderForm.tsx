...
export default function TourPackageHeaderForm() {
    ...
    useEffect(() => {
        const fetchHeaderData = async () => {
            try {
                const response = await fetch('/api/tours/header');
                if (response.ok) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                const refreshResponse = await fetch('/api/tours/header');
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Enter page title (e.g., Tour Packages)"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="Enter page subtitle (e.g., Discover the Beauty of West Sumatra)"
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                placeholder="Enter page description (e.g., Explore our carefully crafted tour packages...)"
                                rows={4}
