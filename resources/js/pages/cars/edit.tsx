...
export default function CarEdit({ car }: CarEditProps) {
    ...
    const { data, setData, processing, errors } = useForm({
        ...
        specifications: car.specifications && car.specifications.length > 0 ? car.specifications : [{ key: '', value: '' }],
        features_detail: car.features_detail && car.features_detail.length > 0 ? car.features_detail : [''],
        included: car.included && car.included.length > 0 ? car.included : [''],
        terms: car.terms && car.terms.length > 0 ? car.terms : [''],
        pricing: car.pricing && car.pricing.length > 0 ? car.pricing : [{ duration: '', price: '', note: '' }],
        _method: 'PUT',
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        // Add image file first if provided
        if (data.image) {
        ...
        router.post(`/cars/${car.slug}`, formData, {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold">Edit Car Rental</h1>
